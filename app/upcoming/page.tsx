...
export default function UpcomingPage() {
  ...
  const renderActionButtons = (lead: any) => (
    <button
      ...
      className={`px-3 py-1 text-sm rounded-md transition-colors ${activeTab === 'upcoming'
        ...
        <div className="border-b border-gray-200">
          <nav className="flex space-x-8 px-6">
            ...
            <button
              ...
              className={`py-4 px-1 border-b-2 font-medium text-sm transition-colors ${activeTab === 'thisWeek'
